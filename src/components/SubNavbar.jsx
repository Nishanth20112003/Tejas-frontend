...
const SubNavbar = () => {
  return (
    <>
      <div className="subNavbar bg-primary w-full h-[45px] px-[40px] py-2 text-white flex items-center justify-between">
        <p className="font-georgia">Welcome to Tejas Furniture</p>
        <div className="flex gap-10">
          <div className="icons-container flex gap-4 items-center w-[fit-content] ">
            <svg
          ...
          <div className="call-section flex gap-3 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
              height="22"
            ...
            <p className="font-manrope">+91 93602 31581</p>
          </div>
        </div>
      </div>
    </>
